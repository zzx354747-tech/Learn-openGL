...
void LightUniformSetter::apply( Shader& shader, const LightSettings& lightSettings, const SceneRenderConfig& config, const SceneRenderState& state, const Camera& camera )
{
...
void LightUniformSetter::setupPointLight( Shader& shader, const SceneRenderState& state, const LightSettings& lightSettings )
{
...
glm::vec3 LightUniformSetter::getFlashLightPosition( const Camera& camera, const LightSettings& lightSettings )
{
