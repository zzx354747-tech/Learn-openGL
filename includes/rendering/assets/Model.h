...
unsigned int TextureFromEmbedded(const aiTexture *texture, bool gamma = false);
        ...
        for(unsigned int i = 0; i < mat->GetTextureCount(type); i++)
        {
            ...
            {   // if texture hasn't been loaded already, load it
                ...
                if (str.C_Str()[0] == '*')
                {
                    ...
                    {
                        std::cout << "Embedded texture index out of range: " << str.C_Str() << std::endl;
                        texture.id = 0;
                    }
                }
                else
...
unsigned int TextureFromEmbedded(const aiTexture *texture, bool gamma)
{
    unsigned int textureID;
    glGenTextures(1, &textureID);
