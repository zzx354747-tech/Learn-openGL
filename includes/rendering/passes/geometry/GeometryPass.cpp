...
GeometryPass::GeometryPass( SceneRenderResources& resources, SceneRenderConfig& config, SceneRenderState& state, Camera& camera, SceneDrawer& drawer, GBuffer& gBuffer ) : resources(resources), config(config), state(state), camera(camera), drawer(drawer), gBuffer(gBuffer)
{}
